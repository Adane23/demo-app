...
function AddEmployee(props) {
    //Declare state variables for each of the forms fields
    ...
    function handleSubmit (event) {
        //Prvent the default behavior of the form submission
        event.preventDefault();

        //Prepare the data to be sent to the server the key should be macth with the database attribute name
        const data = {
